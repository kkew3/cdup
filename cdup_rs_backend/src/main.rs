...
fn main() {
    ...
    match cli.rule_type {
        RuleType::N => handle_n(&mut cli.fromdir, cli.rule_value),
        RuleType::Raw => handle_raw(&mut cli.fromdir, cli.rule_value),
        RuleType::Glob => handle_glob(&mut cli.fromdir, cli.rule_value),
        RuleType::Regex => handle_regex(&mut cli.fromdir, cli.rule_value),
    }
